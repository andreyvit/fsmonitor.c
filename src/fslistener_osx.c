...
static void FSMonitorEventStreamCallback(ConstFSEventStreamRef streamRef, fslistener_t *listener, size_t numEvents, char *eventPaths[], const FSEventStreamEventFlags eventFlags[], const FSEventStreamEventId eventIds[]);
...
fslistener_t *fslistener_create(const char *path, fslistener_callback_t callback, void *data) {
  ...
  listener->streamRef = FSEventStreamCreate(NULL, (FSEventStreamCallback)FSMonitorEventStreamCallback, &context, paths, kFSEventStreamEventIdSinceNow, 0.05, 0);
...
void FSMonitorEventStreamCallback(ConstFSEventStreamRef streamRef, fslistener_t *listener, size_t numEvents, char *eventPaths[], const FSEventStreamEventFlags eventFlags[], const FSEventStreamEventId eventIds[]) {
